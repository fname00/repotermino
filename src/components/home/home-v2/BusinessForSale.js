...
const BusinessForSale = () => {
  ...
  useEffect(() => {
    const fetchVillas = async () => {
      try {
        const response = await fetch('/api/listings?locale=pl&pageNumber=1&searchQuery=&listingStatus=Buy&propertyTypes=shop&priceRange=0,10000000&bedrooms=0&bathrooms=0&location=All%20Cities&squareFeet=&yearBuild=&categories=&currentSortingOption=Price%20High'); // Adjust the query params as needed
