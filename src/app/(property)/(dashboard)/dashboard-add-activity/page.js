...
import AddPropertyTabContent from "@/components/property/dashboard/dashboard-add-activity";

export const metadata = {
  title: "Dashboard Add Activity || Teneryfa.org.pl",
};

const DashboardAddActivity = async () => {
